...
// The same sets a site gets from SymfonyMigrate.sh, deliberately: the bundle and the applications installing it are then held to one and the same standard, and neither can drift ahead of the other
